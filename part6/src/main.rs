...
// If a fn accepts a slice, you can give it a borrowed vec &[i64]
// This is because of traits, when you borrow a type, you can translate it into a different reference type
